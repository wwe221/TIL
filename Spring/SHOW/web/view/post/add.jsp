...
<tr><td>제목</td><td>${contentTitle}</td></tr>
<!-- 종류와 콘텐츠 입력 값은 사용자 선택 값을 받아서 뿌려줌 -->

<tr><td>제목</td><td><input type="text" name="title" id="title_field" placeholder="제목을 입력해주세요"></td></tr>
...
<input type="hidden" name="contents" value="${contentId}">
