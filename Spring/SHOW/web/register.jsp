...
$(document).ready(function(){
	...
	$("input[name='pwdck']").keypress(function () {
		if ($(this).val() == $('input[name=pwd]').val()) {
			...
			$('#pwdcklable').text("password를 다시 확인해주세요.");
		}
	});
        ...
        <form action="useraddimpl.sh" method="POST">
            ...
            <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  ...
                  <label for="inputPassword" id="pwdlable">Password</label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-label-group">
                  ...
                  <label for="confirmPassword" id="pwdcklable">Confirm password</label>
                </div>
              </div>
            </div>
		  </div>
		  <div class="form-group">
            <div class="form-label-group">
              ...
              <label for="inputEmail" id="emaillable">Email address</label>
            </div>
          </div>
		  <input type="hidden" value="default" name=icon>
          <input type="submit" name="register" class="btn btn-primary btn-block" value="Register" disabled>
        </form>
        <div class="text-center">
          <a class="d-block small mt-3" href="login.sh">Login Page</a>
