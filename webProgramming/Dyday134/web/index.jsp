		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-cog"></i> <span>User</span>
			</a>
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Custom Components:</h6>
						<a class="collapse-item" href="user.do?view=useradd">Add</a> <a
							class="collapse-item" href="user.do?cmd=userlist">List</a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseUtilities" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="utilities-color.html">Add</a> <a
							class="collapse-item" href="utilities-border.html">List</a>
					</div>
				</div></li>
			...
			<div id="content">
							...
							<c:when test="${loginuser!=null}">
								...
								<li class="nav-item dropdown no-arrow"><a
									...
									aria-expanded="false"> <span
										class="mr-2 d-none d-lg-inline text-gray-600 small">${loginuser.name}</span>
									...
									<div
										...
										<a class="dropdown-item" href="user.do?cmd=userdetail&id=${loginuser.id}"> <i
				...
				<div class="container-fluid">
					...
					<div class="row">
									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<div
													class="text-xs font-weight-bold text-primary text-uppercase mb-1">ADD</div>
											</div>
											<div class="col-auto">
									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												<div class="h5 mb-0 font-weight-bold text-gray-800">USER</div>
												<div
													class="text-xs font-weight-bold text-success text-uppercase mb-1">List</div>
											</div>
											<div class="col-auto">
						...
						<div class="col-xl-3 col-md-6 mb-4">
							<a href="product.do?view=productadd">
								<div class="card border-left-primary shadow h-100 py-2">
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
						...
						<!-- Earnings (Monthly) Card Example -->
						<div class="col-xl-3 col-md-6 mb-4">
							<a href="product.do?cmd=productlist">
								<div class="card border-left-success shadow h-100 py-2">
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
